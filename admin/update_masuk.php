...
<section class="content-header">
  <font size="4px">Tambah Surat Masuk</font>
</section>
<section class="content">
 <div class="box box-primary" style="width:100%;margin:0 auto;">
	<div class="box-body"  style="width:99.5%">
      ...
      <tr><div class="form-group">
          <td style="font-size:90%"><label for="exampleInputEmail1">Pengirim Surat</label></td><td>:</td>
          <td><input type="text" class="form-control" value="<?php echo $bc['pengirim']; ?>" name="pengirim" placeholder="" required></td>
          </div>
      </tr>
      <tr><div class="form-group">
      ...
      <tr>
        <tr>
          <div class="form-group">
              ...
              <td><input type="file" name="surat" value="<?php echo $bc['namafile']; ?>"></td>
              </div>
        </tr>
        <td></td>
...
if (isset($_POST['submit'])) {
 ...
 include '../config/koneksi.php';
     ...
     $ukurangambar=$_FILES['surat']['size'];
                ...
                echo "$namafile";
                      if(empty($namafile) and empty($tipe_file) and empty($lokasifile) and empty($ukuranfile)){
                            mysql_query("UPDATE surat SET judul_surat='$judul_surat', nmr_surat='$nmr_surat', tgl_surat='$tgl_surat', prihal='$prihal',
                            jenis_surat='1', pengirim='$pengirim', penerima='tata usaha', tema='$tema',
                            lampiran='$lampiran', keterangan='$keterangan' WHERE kd_surat='$_GET[kd]'");
              }else{
