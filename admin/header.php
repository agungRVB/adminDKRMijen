...
<html>
  <head>
    ...
    <title>.::Tata Kelola Administrasi Dewan Kerja::.</title>
    ...
    <div class="wrapper">
      <header class="main-header">
        ...
        <a class="logo">
          ...
          <span class="logo-mini"><b>DKR</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>DKR 33.015 MIJEN</b></span>
        </a>
        ...
        <section class="sidebar"><br/>
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="../images/dkr.png" class="img-circle" alt="User Image">
            </div>
            <div class="pull-left info">
              <pixels>Salam... <br> Kak Admin <?php// echo $nama;?></p>
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="index.php"><i class="fa fa-home" style="color:orange"></i> <span  style="color:orange">Beranda</span></a></li>
            <li><a href="?menu=surat-masuk"><i class="fa fa-inbox" style="color:orange"></i> <span  style="color:orange">Surat Masuk</span></a></li>
            <li><a href="?menu=surat-keluar"><i class="fa fa-send" style="color:orange"></i> <span  style="color:orange">Surat Keluar</span></a></li>
            <li><a href="?menu=log"><i class="fa fa-exchange" style="color:orange"></i> <span style="color:orange">Log Book</span></a></li>
            <li><a href="#"><i class="fa fa-users" style="color:orange"></i> <span style="color:orange">Anggota DKR</span></a></li>
            <li><a href="#"><i class="fa  fa-money" style="color:orange"></i> <span style="color:orange">Keuangan</span></a></li>
            <li class="treeview">
              <a href="#">
                <i class="fa  fa-heartbeat" style="color:orange"></i> <span style="color:orange">DINAS KESEHATAN</span>
                <i class="fa fa-angle-right pull-right"></i>
              </a>
              <li class="treeview-menu sidebar-menu">

                      <li><a href='#' ><i class='fa fa-circle-o'></i> Surat Masuk</a></li>
                      <li><a href='#' ><i class='fa fa-circle-o'></i> Surat keluar</a></li>
                      <li><a href='#' ><i class='fa fa-circle-o'></i> Log Book</a></li>

              </li>
            </li>
            <li><a href="?menu=user"><i class="fa fa-user-plus" style="color:orange"></i> <span  style="color:orange">Kelola User</span></a></li>
