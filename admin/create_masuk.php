 ...
 <div class="box box-primary" style="width:100%;margin:0 auto;">
	<div class="box-body"  style="width:99.5%">
      ...
      <tr><div class="form-group">
          ...
          <td><input type="text" class="form-control" name="pengirim" placeholder="" required></td>
          </div>
      </tr>
      <tr><div class="form-group">
...
move_uploaded_file($lokasifile,"$direktori");
       ...
       ('','$judul_surat','$nmr_surat','$tgl_surat','$prihal','1','$pengirim','tata usaha','$tema','$lampiran','$direktori','$keterangan')");
     }
}
 ?>
