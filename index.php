  ...
  <form class="" action="config/login.php" method="post">
    <div class="login">
      <div class="login__form">
        <img src="images/dkr.png" width="300px" height="300px"><br/>
          <div style="font-size:30; font-family:tahoma;">
            <b>GERAKAN PRAMUKA KWARTIR RANTING MIJEN <br> KWARTIR CABANG KOTA SEMARANG <br><div style="color:orange">
              DEWAN KERJA RANTING MIJEN
            </div> </b>
          </div>
        <br/><br/><br/>
